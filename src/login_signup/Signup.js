...
import logo from './edfund.io.png'
...
const Signup = ({setUser}) => {
  ...
  return (
    <div className="h-screen w-screen overflow-y-hidden flex items-center justify-center" style={{ backgroundImage: `url("https://kpmg.com/content/dam/kpmg/in/images/2022/05/top-15-priorities-transformation-of-indian-healthcare-2024-healthcare-agenda.jpg")`, backgroundRepeat:"no-repeat", backgroundSize:"cover"}}>

        <div className="h-screen w-[45%] bg-white flex flex-col item-center justify-center">

            <img src={logo} style={{height:"auto", width:"50%"}} alt="edfund.io logo"/>
