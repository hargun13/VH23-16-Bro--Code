...
import image from './fund_image.png'
...
const Fundraiser = () => {
  return (
    <div className='h-[88.6vh] w-full flex items-center justify-center gap-4 font-semibold' style={{backgroundImage: `url(${bg})`, backgroundRepeat:"no-repeat", backgroundSize:"cover"}}>
        ...
        <div className='w-[50%]'>
            <p className='text-4xl px-10 '>Help Us Cater More Students In Need Through Our Platform</p>
            <p className='text-4xl px-10 py-10'>Sponsor Capable Students For the Greater Good!!</p>
